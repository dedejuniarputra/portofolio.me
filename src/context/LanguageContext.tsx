...
export const translations = {
  EN: {
    ...
    about: {
      ...
      titleHighlight: 'Know',
      titlePart2: 'Me',
      subtitle: 'Junior Software Developer — Universitas Lampung',
      bio1Prefix: "Hello, I'm ",
      name: "Dede Juniar Putra",
      bio1Suffix: ", a Junior Software Developer based in Bandar Lampung, Indonesia — specializing in web development with a foundational understanding of mobile application development. I have experience developing applications across the frontend, backend, and database layers, while understanding system requirements analysis and troubleshooting.",
      bio2: "In web development, I have experience using Laravel, PHP, JavaScript, and Tailwind CSS, along with MySQL for database management. For mobile development, I have experience with Flutter, Kotlin, and Firebase. I also understand REST APIs, Git & GitHub, and am accustomed to testing, debugging, troubleshooting, and system maintenance. Currently, I am expanding my skills with React.js, Next.js, and WordPress to broaden my expertise in website development and management.",
      bio3: "I hold a Bachelor's degree in Computer Science from the University of Lampung, with 2 years of experience in Web Development and Mobile Development. Currently, I am open to roles as a Software Engineer, Web Developer, Mobile Developer, System Analyst, or IT Support. I am ready to continuously learn, sharpen my skills, and contribute through effective technology solutions tailored to user needs.",
      stats: {
    ...
    skills: {
      ...
      categories: [
        ...
        },
        {
          num: '04',
          label: 'TOOLS & HOSTING',
          items: ['VS Code', 'Antigravity', 'Git', 'GitHub', 'Laragon', 'Vercel', 'Hostinger', 'Figma', 'WordPress'],
        },
        {
          num: '05',
          label: 'AI TOOLS',
    ...
    certificates: {
      ...
      items: [
        ...
        { id: 17, title: 'WordPress Development', issuer: 'MySkill', date: '2026', category: 'WEB', url: 'https://drive.google.com/file/d/1iGE8xoP9WDBGFx7tCDMPhrf39AuOifjv/view?usp=drive_link' },
        ...
        { id: 18, title: 'Belajar Git', issuer: 'CODEPOLITAN', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/1Vvv_FJJwS7-Pol3Ey-goDHJ4xUfU-m7I/view?usp=drive_link' },
  ...
  ID: {
    ...
    about: {
      ...
      name: "Dede Juniar Putra",
      bio1Suffix: ", seorang Junior Software Developer asal Bandar Lampung, Lampung — berfokus pada pengembangan web dan memiliki pemahaman dasar dalam pengembangan aplikasi mobile. Saya memiliki pengalaman mengembangkan aplikasi dari sisi frontend, backend, hingga basis data, serta memahami proses analisis kebutuhan sistem dan troubleshooting.",
      bio2: "Dalam pengembangan web, saya memiliki pengalaman menggunakan Laravel, PHP, JavaScript, dan Tailwind CSS, serta MySQL untuk pengelolaan database. Untuk mobile development, saya memiliki pengalaman menggunakan Flutter, Kotlin, dan Firebase. Saya juga memahami REST API, Git & GitHub, serta terbiasa melakukan testing, debugging, troubleshooting, dan pemeliharaan sistem. Saat ini saya sedang mempelajari React.js, Next.js, dan WordPress untuk memperluas kemampuan serta pemahaman saya dalam pengembangan dan pengelolaan website.",
      bio3: "Saya merupakan lulusan S1 Ilmu Komputer Universitas Lampung dengan pengalaman 2 tahun di bidang Web Development dan Mobile Development. Saat ini saya terbuka untuk peluang sebagai Software Engineer, Web Developer, Mobile Developer, System Analyst, maupun IT Support. Saya siap terus belajar, mengembangkan kemampuan, dan berkontribusi melalui solusi teknologi yang efektif serta sesuai dengan kebutuhan pengguna.",
      stats: {
    ...
    certificates: {
      ...
      seeLess: 'Tampilkan Lebih Sedikit',
      items: [
        { id: 1, title: 'Front-end Untuk Pemula', issuer: 'Dicoding Camp 2026', date: '2026', category: 'WEB', url: 'https://drive.google.com/file/d/1MeC3V9Oj146_D-1yrhjT3HshlMj2A6ue/view?usp=drive_link' },
        { id: 2, title: 'Dasar Pemrograman Javascript', issuer: 'Dicoding Camp 2026', date: '2026', category: 'WEB', url: 'https://drive.google.com/file/d/1bTSLiu6gM5rxK4yKRa_PTyYolGN2j-WE/view?usp=drive_link' },
        { id: 3, title: 'Dasar Pemrograman Web', issuer: 'Dicoding Camp 2026', date: '2026', category: 'WEB', url: 'https://drive.google.com/file/d/1xhzsU8O7wsfaM-0JvH5yhZOS1RKOvjym/view?usp=drive_link' },
        { id: 17, title: 'WordPress Development', issuer: 'MySkill', date: '2026', category: 'WEB', url: 'https://drive.google.com/file/d/1iGE8xoP9WDBGFx7tCDMPhrf39AuOifjv/view?usp=drive_link' },
        { id: 4, title: 'Belajar Dasar AI', issuer: 'DICODING INDONESIA', date: '2026', category: 'OTHER', url: 'https://drive.google.com/file/d/1zl2qyMK8x4_1gQiIcn5_9T35excXfL7i/view?usp=drive_link' },
        { id: 5, title: 'Belajar Dasar IT Support', issuer: 'DICODING INDONESIA', date: '2026', category: 'OTHER', url: 'https://drive.google.com/file/d/18t0XQc9Bw-9_Y01V13u-6z5769jVd13g/view?usp=drive_link' },
        { id: 6, title: 'Belajar Membuat Aplikasi Flutter untuk Pemula', issuer: 'DICODING INDONESIA', date: '2026', category: 'MOBILE', url: 'https://drive.google.com/file/d/1XBx2UdlR14oGpgkVpzwx8Jmc82vukqDy/view?usp=drive_link' },
        { id: 7, title: 'Belajar Dasar Pengembangan Aplikasi Mobile', issuer: 'DICODING INDONESIA', date: '2026', category: 'MOBILE', url: 'https://drive.google.com/file/d/1Cp6az_deZrgU4ef_Hk4ukGrtphzi4lhX/view?usp=drive_link' },
        { id: 8, title: 'Memulai Pemrograman dengan Dart', issuer: 'DICODING INDONESIA', date: '2026', category: 'MOBILE', url: 'https://drive.google.com/file/d/1EcEDK6MKA1trOtBty6JDXD7CjpIMg1gh/view?usp=drive_link' },
        { id: 9, title: 'Introduction to Financial Literacy', issuer: 'DICODING INDONESIA', date: '2026', category: 'OTHER', url: 'https://drive.google.com/file/d/1r1zqqryZVjiCxnUF4RSUJpj0TclazQ_M/view?usp=drive_link' },
        { id: 10, title: 'Short Class UI/UX DESAIN', issuer: 'Myskill', date: '2025', category: 'OTHER', url: '#' },
        { id: 11, title: 'Tutorial CRUD dengan PHP', issuer: 'DUNIA CODING', date: '2025', category: 'WEB', url: 'https://drive.google.com/file/d/13AlduaHYv6uFeAbwswiceFoOGAgtzJUt/view?usp=drive_link' },
        { id: 12, title: 'Advanced Mobile Programming', issuer: 'UNIVERSITAS LAMPUNG', date: '2025', category: 'MOBILE', url: 'https://drive.google.com/file/d/1_HPi7REcY8BtYJFwGI4VkW-_tbYVDLI3/view?usp=drive_link' },
        { id: 13, title: 'Mobile Apps and Technology', issuer: 'UNIVERSITAS LAMPUNG', date: '2025', category: 'MOBILE', url: 'https://drive.google.com/file/d/1fiOhjyUzHYoW5VK9CUFn-i9RczHJrHf3/view?usp=drive_link' },
        { id: 14, title: 'Operating Systems', issuer: 'UNIVERSITAS LAMPUNG', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/11GUaWzL4WpI2NScxaooe_UKO5-K2iVEE/view?usp=sharing' },
        { id: 15, title: 'HTML', issuer: 'Sololearn', date: '2024', category: 'WEB', url: 'https://drive.google.com/file/d/1qhyLvTCnDLXyDqm2MTdSeOTU1eih3Tar/view?usp=drive_link' },
        { id: 16, title: 'Google Analytics untuk pemula', issuer: 'GOOGLE', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/16qhYd3DFkQyc8djg1JBs2ltI1k-i_CLs/view?usp=sharing' },
        { id: 18, title: 'Belajar Git', issuer: 'CODEPOLITAN', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/1Vvv_FJJwS7-Pol3Ey-goDHJ4xUfU-m7I/view?usp=drive_link' },
        { id: 19, title: 'UI/UX Designer', issuer: 'DIGITALENT', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/1zTl1rfpMv6Of7H0mOuNha1oDp7hhtFm3/view?usp=sharing' },
        { id: 20, title: 'Worskhop Nasional HIMAKOM x XDEMIA', issuer: 'XDEMIA', date: '2024', category: 'OTHER', url: 'https://drive.google.com/file/d/1-38Rq-WHOvjAwciLIN3WB16jGZB_2Qqf/view?usp=drive_link' },
        { id: 21, title: 'Graphic Design Training', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1mlbrQGal_5mpCJJ6Kk7EzyYnUcmLw8oQ/view?usp=drive_link' },
        { id: 22, title: 'General Lecture Participant', issuer: 'FMIPA UNILA', date: '2023', category: 'OTHER', url: '#' },
        { id: 23, title: 'HINCAR Participant', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1qRMNu2l6TO52pXw60_0lcnDa-wuWDKdi/view?usp=sharing' },
        { id: 24, title: 'Public Lecture on Blockchain', issuer: 'FMIPA UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1yFNW3LUN8fAdiZOHKpzVnLv-6lWqSh-D/view?usp=drive_link' },
        { id: 25, title: 'Scientific Study Tour', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: '#' },
        { id: 26, title: 'Computer Science Showdown', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1awyyAx0gYWGI4uPIRVLcMQ5_gXHcEugV/view?usp=sharing' },
        { id: 27, title: 'PANITIA PRJXHT 2023', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1-vRRzXQflvews6df-BBRYIWQyfRuZSNm/view?usp=sharing' },
        { id: 28, title: 'PANITIA LKMMIK-TD 2023', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1l3LRUmvNu05nDdgjkqEi8gLhxov9rkOH/view?usp=drive_link' },
        { id: 29, title: 'PANITIA PRINTER 2023', issuer: 'HIMAKOM UNILA', date: '2023', category: 'OTHER', url: 'https://drive.google.com/file/d/1wBL6zshmZlnbKfBjSki9oKy-EhJbhTv7/view?usp=drive_link' },
        { id: 30, title: 'PESERTA - LKMMIK-TD 2022', issuer: 'HIMAKOM UNILA', date: '2022', category: 'OTHER', url: 'https://drive.google.com/file/d/1Fo6t-tSCvQw02UfUQ0L3kWPDITJn65lj/view?usp=sharing' },
        { id: 31, title: 'PESERTA PRINTER 2022', issuer: 'HIMAKOM UNILA', date: '2022', category: 'OTHER', url: 'https://drive.google.com/file/d/14jNU3N1Q5Qfw4tjAObJBVWCUZ7wR7N57/view?usp=sharing' },
        { id: 32, title: '2nd Place in Valorant', issuer: 'HIMAKOM UNILA', date: '2022', category: 'OTHER', url: 'https://drive.google.com/file/d/1L-zhJ1QqAwqIcz5kcp9A6y7Hgo1OEqcu/view?usp=sharing' },
        { id: 33, title: 'BIMTEK Artificial Intelligence', issuer: 'BRIN 2026', date: '2026', category: 'OTHER', url: 'https://drive.google.com/file/d/1NfJvl3WOtwxF4edcQHrD4HQKBuwuBcKk/view?usp=sharing' }
      ]
    },
    contact: {
