...
export default function Hero() {
  ...
  const handleCopyCode = () => {
    const infoString = `Dede Juniar Putra | Junior Software Developer & System Analyst`;
      ...
      <div className="max-w-7xl w-full mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col items-start space-y-6 text-left">
          ...
          <div className="flex items-center gap-2 sm:gap-3.5 pt-2 w-full max-w-full overflow-x-auto scrollbar-none">
            ...
            <a
              href="https://drive.google.com/file/d/1j-cTJrUaemfzdwytK8SzFtg5jNnEP_bS/view?usp=drive_link"
              target="_blank"
